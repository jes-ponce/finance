...
@Component({
  ...
  template: `
    <div class="min-h-screen bg-slate-950 flex items-center justify-center px-4 py-12"
         style="background: radial-gradient(ellipse at 40% 0%, rgba(99,102,241,0.15) 0%, transparent 60%), radial-gradient(ellipse at 90% 85%, rgba(99,102,241,0.08) 0%, transparent 50%), #020617;">
      ...
      <div class="w-full max-w-md">
        ...
        <div class="bg-slate-900 rounded-2xl shadow-2xl shadow-black/60 border border-slate-800/60 px-8 py-10">
          ...
          <div class="mb-8">
            ...
            <p class="text-slate-400 text-sm">Comienza a gestionar tus finanzas hoy</p>
          </div>
            ...
            <div>
              ...
              <div class="relative">
                ...
                <input
                  ...
                  class="w-full bg-slate-800/70 border border-slate-700/60 text-white placeholder-slate-500 rounded-xl pl-10 pr-11 py-3 text-sm
                         focus:outline-none focus:ring-2 focus:ring-indigo-500/50 focus:border-indigo-500/50 transition-all duration-200"
                  [class.border-red-500/60]="confirmPassword() && password() !== confirmPassword()"
                  [class.focus:ring-red-500/50]="confirmPassword() && password() !== confirmPassword()"
                />
                <button
                  type="button"
...
export class RegisterComponent {
  ...
  get nameValue() { return this.name(); }
  set nameValue(v: string) { this.name.set(v); }
  ...
  get confirmPasswordValue() { return this.confirmPassword(); }
  set confirmPasswordValue(v: string) { this.confirmPassword.set(v); }
